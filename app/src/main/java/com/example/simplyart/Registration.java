...
import com.example.simplyart.ReusableCode.ReusableCodeForAll;
import com.example.simplyart.models.Passwords;
import com.example.simplyart.models.Users;
import com.example.simplyart.models.privatedetails;

public class Registration extends AppCompatActivity {

    TextView alreadyhaveacc;
    TextInputLayout Fname,Username, Email, Pass,Gender,Description,Website;
    EditText Birth;
    int year,month,day;
    Button register;
    FirebaseAuth FAuth;
    ...
    String fname,username,email,pass,gender,description,website,birth;
    String useridd;
                                ...
                                FAuth.createUserWithEmailAndPassword(email, pass).addOnCompleteListener(new OnCompleteListener<AuthResult>() {
                                    ...
                                    public void onComplete(@NonNull Task<AuthResult> task) {
                                        if (task.isSuccessful()) {
                                            ...
                                            addPrivateDetails(useridd,email,gender,birth);
                                            addPasswords(pass);
    ...
    public boolean isValid() {
        ...
        isvalid = isValidname && isValidemail && isvalidpassword && isvalidgender && isvalidusername;
        return isvalid;
    }
